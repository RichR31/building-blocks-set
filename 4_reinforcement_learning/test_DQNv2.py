...
if __name__ == '__main__':
    ...
    text_file = open("output/dqn_v2.txt", "w")

    print("_____ EVAL DQN v2 STARTED ______")
    ...
    loaded_model = DQN.load(f"{dir_path}/DQN-BuildingBlocks_v2")
